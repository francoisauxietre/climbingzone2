# climbingzone2
 ...
 attention beaucoup de probleme
  mettre a faux le cloud 
  aller changer root et vide dans les parametres de ficiers yaml
...
To build the final jar and optimize the climbingzone2 application for production, run:
