...
import { getEntities } from './climber.reducer';
...
export class Climber extends React.Component<IClimberProps, IClimberState> {
  ...
  render() {
    const { climberList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="climber-heading">
          <Translate contentKey="climbingzone2App.climber.home.title">Climbers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="climbingzone2App.climber.home.createLabel">Create new Climber</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {climberList && climberList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('firstName')}>
                    <Translate contentKey="climbingzone2App.climber.firstName">First Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('lastName')}>
                    <Translate contentKey="climbingzone2App.climber.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('birth')}>
                    <Translate contentKey="climbingzone2App.climber.birth">Birth</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {climberList.map((climber, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <TextFormat type="date" value={climber.birth} format={APP_LOCAL_DATE_FORMAT} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="climbingzone2App.climber.home.notFound">No Climbers found</Translate>
            </div>
          )}
        </div>
        <div className={climberList && climberList.length > 0 ? '' : 'd-none'}>
